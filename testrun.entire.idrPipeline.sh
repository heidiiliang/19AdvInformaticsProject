...
# ------------------------------------------------------------------------------------------------
cp -r /share/samdata/yhliang/code/idr-code/homer-idr/idr/* .
...
cp H37_150bp.peaks.txt peaks/replicates/
cp H38_150bp.peaks.txt peaks/replicates/
cp H39_150bp.peaks.txt peaks/replicates/
...
makeTagDirectory Combined -d /share/samdata/yhliang/19advinformatics/wk6to10/Finalproject/H37/homer-tags /share/samdata/yhliang/19advinformatics/wk6to10/Finalproject/H38/homer-tags /share/samdata/yhliang/19advinformatics/wk6to10/Finalproject/H39/homer-tags
cd Combined
findPeaks ./ -LP .1 -poisson .1 -style factor -size 150 -minDist 50 -localSize 50000 -o combined.peaks.txt
cd ../
# (/share/samdata/yhliang/19advinformatics/wk6to10/Finalproject/peakcalling-idr/150bp/peaks)


qsub 2testrun.entire.idrPipeline.sh
